...
function setQuestion() {
    ...
    if (json_file[curr_question].o1 === json_file[curr_question].answer || json_file[curr_question].o2 === json_file[curr_question].answer) {
        answers[0].answerText = json_file[curr_question].o1;
        answers[1].answerText = json_file[curr_question].o2;
    }else{
        let ranX = getRandomNumber()
        if (ranX === 0) {
            answers[0].answerText = json_file[curr_question].o1;
            answers[1].answerText = json_file[curr_question].answer;
        }else{
            answers[0].answerText = json_file[curr_question].answer;
            answers[1].answerText = json_file[curr_question].o2;
        }
    }
